...
export default function Header() {
  ...
  const highlightColor = isActive ? 'text-indigo-500' : 'text-emerald-500';
  ...
  return (
    <header className="h-16 border-b border-zinc-900 flex items-center justify-end px-10 bg-black flex-shrink-0">
      <div className="flex items-center gap-6">
        ...
        >
          {privacy ? (
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className={`w-4 h-4 ${highlightColor}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
