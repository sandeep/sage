            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="card space-y-6 shadow-2xl border-zinc-900 bg-zinc-950/50 p-8 h-full">
                    <div className="flex justify-between items-baseline border-b border-zinc-900 pb-4">
                        ...
                        <div className="text-ui-data text-white">{efficiency.expenseDragBps.toFixed(1)} <span className="ui-caption text-zinc-600 ml-1">bps (Portfolio)</span></div>
                    </div>
                    <div className="space-y-1">
                        ...
                        <div className="text-ui-caption text-zinc-500 uppercase tracking-widest">Fund Management Cost</div>
                    </div>
                </div>
                ...
                <div className="card space-y-6 shadow-2xl border-zinc-900 bg-zinc-950/50 p-8 h-full">
                    <div className="flex justify-between items-baseline border-b border-zinc-900 pb-4">
                        ...
                        <div className="text-ui-data text-white">{efficiency.locationDragBps.toFixed(1)} <span className="ui-caption text-zinc-600 ml-1">bps (Portfolio)</span></div>
                    </div>
                    <div className="space-y-1">
                        <div className="text-ui-data font-bold text-zinc-100">-{fmtUSD(taxLoss)} <span className="ui-caption text-zinc-600 ml-2">per year</span></div>
                        <div className="text-ui-caption text-zinc-500 uppercase tracking-widest">Account Tax Drag</div>
                    </div>
                </div>
                ...
                <div className="card space-y-6 shadow-2xl border-rose-900/30 bg-rose-950/5 p-8 h-full">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="text-ui-caption text-rose-900/60 uppercase tracking-widest">Combined Annual Drag</div>
                    </div>
                </div>
            </div>
