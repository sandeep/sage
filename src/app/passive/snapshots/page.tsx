        ...
        <main className="min-h-screen bg-black text-white font-mono">
            <div className="page-container ui-page-spacing">
                ...
                <div className="flex justify-between items-end border-b border-zinc-900 pb-8">
                    <div>
                        <h1 className="text-ui-hero">SNAPSHOT <span className="text-emerald-500">HISTORY</span></h1>
                        <p className="text-ui-label !text-zinc-500 mt-2 uppercase tracking-[0.3em]">Historical Portfolio States & Ledger Points</p>
                    </div>
                </div>

                {/* Headline Summary Grid */}
                {headline ? (
                    <div className="grid grid-cols-3 gap-px bg-zinc-900 border border-zinc-900 rounded-sm overflow-hidden">
