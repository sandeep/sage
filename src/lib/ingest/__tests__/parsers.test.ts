...
import { parseGenericHoldings } from '../parsers';
import { describe, it, expect } from 'vitest';

describe('parsers', () => {
    it('parseGenericHoldings handles the real CSV format and CORE** cash', () => {
...
218595652,Traditional IRA,CORE**,FDIC-INSURED DEPOSIT SWEEP,,,,$44150.44,,,,,18.81%,,,Cash`;
    ...
    it('parseGenericHoldings identifies 1256 contracts', () => {
...
describe('parseGenericHoldings — ParseResult', () => {
